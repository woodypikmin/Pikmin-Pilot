...
final class Stage8FullLoopController: ObservableObject {
    ...
    func start(
        ...
        emit("STAGE 11.6.0 PILOT RUN START • automation-core=10.3.1 • target=\(goal) • cargo=\(self.cargoMode.displayName) • pikmin=\(self.pikminType.shortName)×\(self.pikminCount) • speed=\(self.fastMode ? "FAST" : "STABLE") • Stage 8.2.2 stable loop core • WDA=OFF")
