...
INSTALL
1. Install PikminPilot-11.5.4.12.ipa on the registered iPhone/iPad.
...
7. Cellular warm-session use: follow the in-app 11.5.4.12 prompts. When a live persistent RSD session already exists, 4G/5G can start directly. A cold cellular bootstrap may still ask for the temporary Airplane Mode step.
